define(function(require, exports, module) {
	...
	var sidebarViewTemplate = require('../../template/server/sidebar.tpl');
    ...
    var SidebarView = Backbone.View.extend({
        ...
        getGroups: function(){
        	...
        	gc.fetch({reset: true,data:{selectItem:'serverMgr'}});
        	return gc;
        },
        ...
        refresh: function(){
        	this.groups.fetch({reset: true,data:{selectItem:'serverMgr'}});
        }
    });
    return SidebarView;
});
